<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="接收者" prop="aims">
        <el-input
          v-model="queryParams.aims"
          placeholder="请输入接收者"
          clearable
          @keyup.enter="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="接收者" align="center" prop="aims" />
      <el-table-column label="备注" align="center" prop="remark" />
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['notice:notice:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['notice:notice:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="noticeRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="接收者" prop="aims">
          <el-input v-model="form.aims" placeholder="请输入接收者" />
        </el-form-item>
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除通知公告编号为"' + _noticeIds + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('notice/notice/export', {
    ...queryParams.value
